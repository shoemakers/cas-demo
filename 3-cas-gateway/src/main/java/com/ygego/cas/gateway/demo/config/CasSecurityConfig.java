package com.ygego.cas.gateway.demo.config;

import com.ygego.cas.gateway.demo.service.CustomUserDetailsService;
...
public class CasSecurityConfig {
    ...
    public ServiceProperties serviceProperties() {
        ...
        //自身服务+/login/cas
        serviceProperties.setService("http://localhost:6001/login/cas");
